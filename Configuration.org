...
| ~dirvish-mode-line-text-size~        | Text height in mode line                 |
...
(use-package dirvish
  ...
  ;; (dirvish-header-line-format '(:left (path) :right (vc-info)))
  ...
  ;;     (format " %s " (propertize (dired-filter--describe-filters)
