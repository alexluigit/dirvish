...
| ~dirvish-enabled-features-on-remote~ | List     | Enabled Dirvish features on remote hosts |
...
| Option                                 | Type     | Description                      |
|----------------------------------------+----------+----------------------------------|
| ~dirvish-side-attributes~                | List     | See ~dirvish-attributes~           |
| ~dirvish-side-preview-dispatchers~       | List     | See ~dirvish-preview-dispatchers~  |
| ~dirvish-side-mode-line-format~          | Plist    | See ~dirvish-mode-line-format~     |
| ~dirvish-side-display-alist~             | Alist    | Size and position of side window |
| ~dirvish-side-window-parameters~         | Alist    | Window parameters of side window |
| ~dirvish-side-open-file-window-function~ | Function | Target window for ~find-file~      |
| ~dirvish-side-follow-buffer-file~        | Boolean  | Follow current ~buffer-file-name~  |
| ~dirvish-side-scope~                     | List     | Scope for side sessions          |
|----------------------------------------+----------+----------------------------------|
...
(use-package dirvish
  ...
  (nil ; Bind `dirvish', `dirvish-dired' and `dirvish-side' as you see fit
   ...
   ([remap dired-sort-toggle-or-edit] . dirvish-ls-switches-menu)
