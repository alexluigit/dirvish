...
(use-package dirvish
  ...
  (setq mouse-1-click-follows-link nil)             ; recommended if you use mouse
  ...
  (("C-c f" . dirvish-fd)
   ...
   ("<mouse-1>" . dirvish-subtree-toggle) ; left click for expand/collapse subtree
   ("<mouse-2>" . dired-mouse-find-file)  ; middle click for opening file / entering dir
   ("<mouse-3>" . dired-up-directory)     ; right click up a directory
