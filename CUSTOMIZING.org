...
(use-package dirvish
  ...
  (("C-c f" . dirvish-fd)
   ...
   ([remap dired-sort-toggle-or-edit] . dirvish-quicksort)   ; "s" by default
   ([remap dired-do-redisplay] . dirvish-ls-switches-menu)   ; "l" by default
   ([remap dired-summary] . dirvish-dispatch)                ; "?" by default
