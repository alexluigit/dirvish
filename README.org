...
+ =M-x= ~dirvish~
  ...
  Welcome to Dirvish 🐱!  It looks very different from Dired, but all Dired
  commands works here.  Press =?= if you need help.

+ =M-x= ~dired~ | ~dired-jump~ | ... (all dired entry commands)

  You should see a "dirv-ish" Dired.

Now use Dirvish to build your brand-new file management workflow!
