...
Since Dirvish is derived from Dired, you have access to all your Dired
commands in =dired-mode-map=.

If you find some Dired command doesn't work as expected, please report an [[https://github.com/alexluigit/dirvish/issues][issue]].
